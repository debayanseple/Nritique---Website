...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-uQy7Yy_G.mjs");
...
const manifest = {
  "9e58baf11c8faa90393eacafd0c351424b17bf15083f49b1a489e8b5e2d5e371": {
    functionName: "submitRegistration_createServerFn_handler",
    importer: () => import("./register.functions-CpT52A7X.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CMfwHP33.mjs"),
    import("./start-FYLuxfXF.mjs"),
