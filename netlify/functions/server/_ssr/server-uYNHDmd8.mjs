...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BeMvTI2V.mjs");
...
const manifest = {
  "9e58baf11c8faa90393eacafd0c351424b17bf15083f49b1a489e8b5e2d5e371": {
    ...
    importer: () => import("./register.functions-C59JMLS3.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BDBM0rT-.mjs"),
    import("./start-CFTj8yaf.mjs"),
