...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BsQQyr5l.mjs");
...
const manifest = {
  "9e58baf11c8faa90393eacafd0c351424b17bf15083f49b1a489e8b5e2d5e371": {
    ...
    importer: () => import("./register.functions-DlZq-4s3.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Z6yghnan.mjs"),
    import("./start-beNSuwJ2.mjs"),
