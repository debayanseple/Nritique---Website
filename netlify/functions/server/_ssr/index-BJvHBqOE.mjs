...
import { N as Navbar, O as Ornament, F as Footer, M as Mandala } from "./Footer-qlDCaDNq.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.form,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Name", value: form.name, onChange: (v) => setForm({ ...form, name: v }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Field,
              {
                label: "Email",
